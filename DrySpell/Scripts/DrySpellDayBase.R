...
jj=1
  ...
  NumberDay=Seasonal%>%
    group_by(X,Y)%>%
    summarise(spell10=CDD_function(prcp=rain,t=2.5,Nb=10))
  ...
  dir.create(paste("/ACMAD_Git/Data/CPC-UNIFIED/DataBase/Number_DrySpell10/",Season_Name,sep = ""),recursive = T,showWarnings = F)
  
  rio::export(NumberDay,paste("/ACMAD_Git/Data/CPC-UNIFIED/DataBase/Number_DrySpell10/",Season_Name,"/",k,".csv",sep = ""))
