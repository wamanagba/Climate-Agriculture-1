...
#Monthly Climatology (Average of the given month from 1981-2010: 30 years)
...
rio::export(Percentage[,c("x","y","RR")],paste("Results/Percentage_",Month_name,"_",Year,".csv",sep=""))
